...
try:
    ...
    pass
try:
    QgsLayoutItemMapClippingSettings.__attribute_docs__ = {'changed': 'Emitted when the atlas clipping settings are changed.\n'}
    QgsLayoutItemMapClippingSettings.__group__ = ['layout']
except (NameError, AttributeError):
    pass
try:
