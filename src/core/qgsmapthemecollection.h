  ...
  public:
    ...
    class CORE_EXPORT MapThemeRecord
    {
      public:
        ...
        QgsMapThemeCollection::MapThemeRecord operator=( const QgsMapThemeCollection::MapThemeRecord &other );
         ...
         * \since QGIS 3.26
         */
        bool hasLayer( QString layerid ) const { return mLayerRecords.isEmpty() ?  false : mLayerRecords.contains( layerid ); }
      ...
      protected:
        ...
        /**
         * Provides the member Layer Record for copying;
         * \since QGIS 3.40
         */
        QMap<QString, MapThemeLayerRecord> dumpRecords() const {return mLayerRecords;}
