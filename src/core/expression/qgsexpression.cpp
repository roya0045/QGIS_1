...
void QgsExpression::initVariableHelp()
{
  ...
  sVariableHelpTexts()->insert( QStringLiteral( "legend_item_expression" ), QCoreApplication::translate( "legend_item_expression", "Expression representing the given legend item." ) );
