...
#ifndef QGSALGORITHMNEARESTLOCATION_H
#define QGSALGORITHMNEARESTLOCATION_H
 ...
 * \ since QGIS 3.16
 */
class QgsNearestLocationAlgorithm : public QgsProcessingAlgorithm
{

  public:

    QgsNearestLocationAlgorithm() = default;
    ...
    QgsNearestLocationAlgorithm *createInstance() const override SIP_FACTORY;
...
#endif // QGSALGORITHMNearestLocation_H
